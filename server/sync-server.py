...
if __name__ == "__main__":
    ...
    print("  Panel web: http://localhost:8080")
    print("=" * 50)
    print()
    print("Instrucciones:")
    print("  1. Pon los archivos .dbf en la carpeta: db_uploads/")
    print("  2. Abri el panel web y hace clic en 'Crear Version'")
    print("  3. Las coneras descargaran la nueva version automaticamente")
    print()
